...
public class InventoryTransferCriteriaController implements Initializable {
        ...
        switch(lsButton){
            ...
            case "btnOk":
                try {
                    ...
                    ShowMessageFX.Error(getStage(), e.getMessage(), InventoryTransferCriteriaController.class.getSimpleName(), "Please inform MIS Department.");
                    //System.exit(1);
                }                
    ...
    private void txtField_KeyPressed(KeyEvent event){
        ...
        if (lnIndex == 3){
            if (event.getCode() == KeyCode.F3){
                ...
                if (loJSON != null){
                    psOrigin = (String) loJSON.get("sBranchCd");
            ...
            if (event.getCode() == KeyCode.F3){
                ...
                if (loJSON != null){
                    psDestinat = (String) loJSON.get("sBranchCd");
        ...
        if(!nv){ /*Lost Focus*/
            switch (lnIndex){
                ...
                case 2: /*dDateThru*/
                   ...
                   break;
                case 3:
                    if (lsValue.equals("")) psOrigin = "";
                    break;
                case 4:
                    if (lsValue.equals("")) psDestinat = "";
                    break;
                default:
