...
public class PurchasesOverrideCriteriaController implements Initializable {
    ...
    private boolean pbIsSummarizedOnly = false;
    ...
    public void isSummarizedOnly(boolean foValue) {
        pbIsSummarizedOnly = foValue;
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        radioBtn02.setDisable(pbIsSummarizedOnly);
    ...
    private void loadRecord() {
        ...
        radioBtn02.setSelected(!pbIsSummarizedOnly);
        radioBtn01.setSelected(pbIsSummarizedOnly);
        psPresentation = (pbIsSummarizedOnly == true ? "0" : "1");
    }
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        switch (lsButton) {
            ...
            case "btnOk":
                ...
                ShowMessageFX.Error(getStage(), e.getMessage(), PurchasesOverrideCriteriaController.class.getSimpleName(), "Please inform MIS Department.");
                //System.exit(1);
            }
