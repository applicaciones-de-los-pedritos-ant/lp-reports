...
public class InvTransferModel {  
    ...
    */
    InvTransferModel(String index01, String index02, String index03, String index04, String index05,
            ...
            String index11, String index12, String index13, String index14){
        ...
        this.sField11 = new SimpleStringProperty(index14);
        this.lField01 = new SimpleDoubleProperty(Double.parseDouble(index11));
        this.lField02 = new SimpleDoubleProperty(Double.parseDouble(index12));
        this.lField03 = new SimpleDoubleProperty(Double.parseDouble(index13));
    }
    
    /*
    *Model for Inv Transfer Summary
    */
    InvTransferModel(String index01, String index02, String index03, String index04, String index05,
