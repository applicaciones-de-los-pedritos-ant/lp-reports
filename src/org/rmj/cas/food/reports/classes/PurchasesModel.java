...
public class PurchasesModel {  
    ...
    */
    PurchasesModel(String index01, String index02, String index03, String index04, String index05,
        ...
        this.nField01 = new SimpleDoubleProperty(Double.parseDouble(index08));
        this.lField01 = new SimpleDoubleProperty(Double.parseDouble(index09));
        this.lField02 = new SimpleDoubleProperty(Double.parseDouble(index10));
    }
    /*
    *Model for Purchases Receiving Detail
    */
    PurchasesModel(String index01, String index02, String index03, String index04, String index05,
            String index06, String index07, String index08, String index09, String index10, String index11, String index12, String index13, String index14){
        this.sField01 = new SimpleStringProperty(index01);
        this.sField02 = new SimpleStringProperty(index02);
        this.sField03 = new SimpleStringProperty(index03);
        this.sField04 = new SimpleStringProperty(index04);
        ...
        this.nField01 = new SimpleDoubleProperty(Double.parseDouble(index12));
        this.nField02 = new SimpleDoubleProperty(Double.parseDouble(index13));
        this.nField03 = new SimpleDoubleProperty(Double.parseDouble(index14));
    }
